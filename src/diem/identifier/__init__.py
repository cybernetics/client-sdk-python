...
def remove_account_subaddress(account_id: str) -> str:
    """remove subaddress in given account identifier and return a new account identifier with subaddress = None"""

    hrp = account_id[:3]
    account_address, _ = decode_account(account_id, hrp)
    return encode_account(account_address, None, hrp)
