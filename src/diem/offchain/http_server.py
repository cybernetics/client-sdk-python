...
from .http_header import X_REQUEST_ID, X_VERIFICATION_KEY_ADDRESS
...
def start_local(
    port: int, process_inbound_request: typing.Callable[[str, str, bytes], typing.Tuple[int, bytes]]
) -> server.HTTPServer:
    ...
    2. LIP-5 account id for verifying JWS signature.
    ...
    class Handler(server.BaseHTTPRequestHandler):
        def do_POST(self):
            ...
            assert x_request_id
            jws_key_address = self.headers[X_VERIFICATION_KEY_ADDRESS]
